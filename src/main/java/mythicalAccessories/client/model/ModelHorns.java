...
public class ModelHorns extends ModelBiped
{
	...
	public ModelHorns(float scale)
	{
		...
		this.bipedHeadwear.addChild(Shape14);
		this.bipedHeadwear.addChild(Shape15);
		this.bipedHeadwear.addChild(Shape16);
		this.bipedHeadwear.addChild(Shape17);
		this.bipedHeadwear.addChild(Shape18);
		this.bipedHeadwear.addChild(Shape19);
		this.bipedHeadwear.addChild(Shape20);
		this.bipedHeadwear.addChild(Shape21);
		this.bipedHeadwear.addChild(Shape22);
		this.bipedHeadwear.addChild(Shape23);
		this.bipedHeadwear.addChild(Shape24);
		this.bipedHeadwear.addChild(Shape25);
		this.bipedHeadwear.addChild(Shape26);
		this.bipedHeadwear.addChild(Shape27);
		this.bipedHeadwear.addChild(Shape28);
		this.bipedHeadwear.addChild(Shape29);
		this.bipedHeadwear.addChild(Shape30);
		this.bipedHeadwear.addChild(Shape31);
		this.bipedHeadwear.addChild(Shape32);
		this.bipedHeadwear.addChild(Shape33);
		this.bipedHeadwear.addChild(Shape34);
		this.bipedHeadwear.addChild(Shape35);
		this.bipedHeadwear.addChild(Shape36);
		this.bipedHeadwear.addChild(Shape37);
